...
from .collect_task_info import GeneralQuests, QuestionInfo, Questions, AnswerCheckbox, GetCheckbox, Checkbox, AnswerRadios, GetRadios, Radios, Common, ValidateCheckbox, ValidateRadios, Questionarie, GeneralText, Text, CollectResults, ResultsPresenter, TaskInfo, CollectTaskInfo
...
__all__ = [
    ...
    'GeneralQuests', 'QuestionInfo', 'Questions', 'AnswerCheckbox', 'GetCheckbox', 'Checkbox', 'AnswerRadios', 'GetRadios', 'Radios', 'Common', 'ValidateCheckbox', 'ValidateRadios', 'Questionarie', 'GeneralText', 'Text', 'CollectResults', 'ResultsPresenter', 'TaskInfo', 'CollectTaskInfo',
    'Time',
    'CollectInfo'
]