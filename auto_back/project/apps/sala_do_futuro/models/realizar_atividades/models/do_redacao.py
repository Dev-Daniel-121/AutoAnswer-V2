...
class DoRedacao:
    def __init__(self, page):
        ...
        self.go = Go(
            page=self.page, get_title_class='span.css-14ra0qi', btn_go_redacoes_class=':nth-match(a.css-lumvx8, 3)', go_btn_class=':nth-match(div.css-39ukww, 2)', go_list_class='li.css-4dqmvd')
