...
from .realizar_atividades.models import DoProvas, DoRedacao, DoTarefas, RealizarProva, RealizarRedacao, CollectInfo, RealizarTarefa
...
__all__ = [
    ...
    'DoProvas', 'DoRedacao', 'DoTarefas', 'RealizarProva', 'RealizarRedacao', 'CollectInfo', 'RealizarTarefa',
    'RealizarAtividades'
]