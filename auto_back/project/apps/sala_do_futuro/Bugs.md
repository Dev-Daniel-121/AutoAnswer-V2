...
## Caso aparecer POP-UP sobre responder Pesquisa
   - Quando há pesquisa pode aparecer um POP-UP para realizar, click no X para não fazer
   - Click no button.css-pfoy33 para fechar

~~~ htlm
<div class="MuiBox-root css-1d5ngp0" tabindex="-1"><button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium css-pfoy33" tabindex="0" type="button"><svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeInherit css-1cw4hi4" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="CloseIcon"><path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></svg></button><div class="MuiBox-root css-eusxcj"><div class="MuiBox-root css-jcy2zd"><p class="MuiTypography-root MuiTypography-body1 css-hbughr">Hora de saber sua opinião 📋</p><div class="MuiBox-root css-0"><p class="MuiTypography-root MuiTypography-body1 css-1jj7ihc">É muito importante ouvir sua opinião para que possamos evoluir sempre!<br><br>Responda nossa rápida pesquisa pressionando o botão abaixo.</p></div></div> </div><div class="MuiBox-root css-1igr75b"><button class="MuiButtonBase-root MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeLarge MuiButton-containedSizeLarge MuiButton-colorPrimary MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeLarge MuiButton-containedSizeLarge MuiButton-colorPrimary css-1q6vtrx" tabindex="0" type="button">Responder Pesquisa<span class="MuiTouchRipple-root css-w0pj6f"></span></button></div></div>
~~~
