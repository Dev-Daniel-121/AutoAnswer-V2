...
class UserService:
    ...
    def criar_usuario(self, nome, sobrenome, tipo_conta, ra, dg_ra, uf_ra):
        ...
        print(f'[{types[7]}] Usuário {nome} {sobrenome} criado com sucesso!')

    def listar_usuarios(self):
        usuarios = self.sistema_usuarios.carregar_usuarios()
        if not usuarios:
            print(f'[{types[8]}] Nenhum usuário cadastrado.')
        else:
    ...
    def atualizar_usuario(self, id_usuario, **kwargs):
        ...
        print(f'[{types[7]}] Usuário {usuario.nome} {usuario.sobrenome} atualizado com sucesso!')
        return True
    ...
    def deletar_usuario(self, id_usuario):
        ...
        self.sistema_usuarios.salvar_usuarios()
        print(f'[{types[7]}] Usuário {usuario.nome} {usuario.sobrenome} deletado com sucesso!')
        return True